...
const RAW_PHONE = "9334559315";
const CONTACT_EMAIL = "withdaniel912@gmail.com";
const CONTACT_PERSON = "Joy";
const COMPANY_NAME = "Nuvyra Technologies";
const WHATSAPP_MESSAGE = encodeURIComponent(
  "Hi Joy, I found Nuvyra Technologies and would like to discuss a website project."
);
const WHATSAPP_LINK = `https://wa.me/91${RAW_PHONE}?text=${WHATSAPP_MESSAGE}`;
...
export function Contact() {
  ...
  return (
    <section
      id="contact"
      className="py-24 sm:py-32 px-4 sm:px-6 lg:px-8 relative scroll-mt-16 bg-[#12372A] text-[#F8FAF9] border-b border-white/10 overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 items-start max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="w-full p-6 sm:p-7 rounded-3xl bg-[#18201F] border border-white/10 space-y-4 mb-6 shadow-2xl">
              ...
              <div className="p-3.5 rounded-xl bg-[#12372A]/80 border border-white/5 flex items-center justify-between text-xs font-medium text-[#F8FAFC]">
              ...
              {/* Action 1: WhatsApp Working Button */}
              <a
                href={WHATSAPP_LINK}
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-between p-3.5 rounded-xl bg-emerald-500/15 border border-emerald-500/30 hover:bg-emerald-500/25 hover:border-emerald-500/40 hover:-translate-y-0.5 active:scale-[0.98] transition-all text-emerald-300 text-xs font-semibold shadow-sm group"
              >
                <div className="flex items-center gap-2.5">
                  <MessageCircle className="h-4 w-4 text-emerald-400 shrink-0" />
                  <span>Chat on WhatsApp &rarr;</span>
                </div>
                <ArrowRight className="h-3.5 w-3.5 text-emerald-400 group-hover:translate-x-1 transition-transform shrink-0" />
              </a>

              {/* Action 2: Direct Email Button */}
              <a
                href={`mailto:${CONTACT_EMAIL}`}
                className="flex items-center justify-between p-3.5 rounded-xl bg-[#12372A]/80 border border-white/10 hover:border-[#2AB7A9]/50 hover:-translate-y-0.5 active:scale-[0.98] transition-all text-[#F8FAFC] text-xs font-semibold group"
              >
                <div className="flex items-center gap-2.5">
                  <Mail className="h-4 w-4 text-[#2AB7A9] shrink-0" />
                  <span>Email Directly &rarr;</span>
                </div>
                <ArrowRight className="h-3.5 w-3.5 text-[#2AB7A9] group-hover:translate-x-1 transition-transform shrink-0" />
              </a>
            </div>
          </motion.div>
